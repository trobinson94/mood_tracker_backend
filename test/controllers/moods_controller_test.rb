...
class MoodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mood" do
    assert_difference('Mood.count') do
      post moods_url, params: { mood: { meds: @mood.meds, notes: @mood.notes, score: @mood.score } }, as: :json
    end
  ...
  test "should update mood" do
    patch mood_url(@mood), params: { mood: { meds: @mood.meds, notes: @mood.notes, score: @mood.score } }, as: :json
    assert_response 200
  end
